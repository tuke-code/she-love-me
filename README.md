...
| 🎯 **军师模式** | 核心问题诊断 + 停止/开始各 3 条具体建议 + 关系推进路线图 |
| 🔍 **AI 深度鉴定** | Claude 读取样本消息，结合统计数据给出有洞察力（且幽默）的结论 |
...
- **v1.0**：文字消息分析 · HTML 报告 · 舔狗/被爱/冷淡指数
- **v2.0**（当前）：依恋类型诊断 · Sternberg 三角 · Gottman 四骑士 · 危险预警 · 军师模式
